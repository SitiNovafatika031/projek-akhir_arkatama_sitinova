    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.pembayaran.update', $pembayaran->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <select id="pemesanan_id" class="form-control @error('pemesanan_id') is-invalid @enderror" name="pemesanan_id" required>
                                    @foreach($pemesanan as $item)
                                        <option value="{{ $item->id }}" {{ $item->id == $pembayaran->pemesanan_id ? 'selected' : '' }}>{{ $item->id }}</option>
                                    @endforeach
                                </select>
                                @error('pemesanan_id')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nama_pelanggan" type="text" class="form-control @error('nama_pelanggan') is-invalid @enderror" name="nama_pelanggan" value="{{ $pembayaran->nama_pelanggan }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="jumlah_transfer" type="number" step="0.01" class="form-control @error('jumlah_transfer') is-invalid @enderror" name="jumlah_transfer" value="{{ $pembayaran->jumlah_transfer }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nama_bank" type="text" class="form-control @error('nama_bank') is-invalid @enderror" name="nama_bank" value="{{ $pembayaran->nama_bank }}" required>
                                @error('nama_bank')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tanggal" type="date" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" value="{{ $pembayaran->tanggal }}" required>
                                @error('tanggal')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($pembayaran->struk_pembayaran)
                                    <div class="mt-2">
                                        <a href="{{ Storage::url($pembayaran->struk_pembayaran) }}" target="_blank">
                                            <img src="{{ Storage::url($pembayaran->struk_pembayaran) }}" alt="Struk Pembayaran" style="width: 100px; height: auto;">
                                        </a>
                                    </div>
                                @endif
                            </div>
